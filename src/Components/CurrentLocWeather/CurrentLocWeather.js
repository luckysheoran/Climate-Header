...
class currLoc extends Component{
constructor(props){
    super();
...
componentDidMount(){
     console.log("Inside Mount")
      ...
      const url=`https://api.openweathermap.org/data/2.5/weather?lat=${this.props.lat}&lon=${this.props.lon}&appid=dbeefb4a696845a0a00074bdc1259f76`
         ...
         fetch(url).then(data=>data.json()).then((data)=>{
            this.setState({
             ...
             this.setState({errorMsg:"Unable to load the weather details for your current location.Please try again."})       
              })
